...
if [[ $input == "1" ]]; then ## Linux
    ...
    if [[ $plat == "1" ]]; then
        ...
        mkdir Payload_List/Simple_Shell 2>/dev/null
            echo -e "[*] The following Reverse Shell will run with netcat listener on the attacker pc:" > Payload_List/Simple_Shell/Shell_list.txt
        ...
        mkdir Payload_List/Bash_Script 2>/dev/null
            echo -e "[*] The following Reverse Shell will run with netcat listener on the attacker pc:" > Payload_List/Bash_Script/Shell_list.txt
            ...
            echo -e "[*] The following Reverse Shell will run with meterpreter or netcat, make sure you set the payload and other options:" >> Payload_List/Bash_Script/Read_Me.txt
            echo -e "\n- set payload cmd/unix/reverse_bash for cmd_unix_rev.sh" >> Payload_List/Bash_Script/Read_Me.txt
        ...
        mkdir Payload_List/Socat 2>/dev/null
            echo -e "[*] The following Reverse Shell will run with netcat listener on the attacker pc:" > Payload_List/Socat/Shell_list.txt
        ...
        mkdir Payload_List/Perl 2>/dev/null
            echo -e "[*] The following Reverse Shell will run with netcat listener on the attacker pc:" > Payload_List/Perl/Shell_list.txt
            ...
            echo -e "\n${BLUE}[+] Creating Payload using msfvenom:${XX}"
            echo -e "\n[*] The following Reverse Shell will run with meterpreter or netcat, make sure you set the payload and other options:" >> Payload_List/Perl/Read_Me.txt
        ...
        mkdir Payload_List/Python 2>/dev/null
            echo -e "[*] The following Reverse Shell will run with netcat listener on the attacker pc:" > Payload_List/Python/Shell_list.txt
            ...
            echo -e "\n${BLUE}[+] Creating Payload using msfvenom:${XX}"
            echo -e "\n[*] The following reverse shell will run with meterpreter or netcat, make sure you set the payload and other options:" >> Payload_List/Python/Read_Me.txt
            echo -e "\n- set payload cmd/unix/reverse_python for cmd_unix_rev.py" >> Payload_List/Python/Read_Me.txt
        ...
        mkdir Payload_List/PHP/Meterpreter_Binaries/ 2>/dev/null
            echo -e "[*] The following Reverse Shell will run with netcat listener on the attacker pc:" > Payload_List/PHP/Shell_list.txt
        ...
        mkdir Payload_List/PHP/Meterpreter_Binaries/Staged 2>/dev/null
            echo -e "[*] The following Reverse Shell will run with meterpreter, make sure you set the payload and other options:" > Payload_List/PHP/Meterpreter_Binaries/Staged/Read_Me.txt
            echo -e "\n- set payload php/meterpreter_reverse_tcp for Rev_TCP_SHell.php" >> Payload_List/PHP/Meterpreter_Binaries/Staged/Read_Me.txt
            echo -e "\n- set payload php/meterpreter/reverse_tcp for Rev_TCP_SHell11.php" >> Payload_List/PHP/Meterpreter_Binaries/Staged/Read_Me.txt
            echo -e "\n- set payload php/meterpreter_reverse_tcp for Rev_TCP_shikata.php" >> Payload_List/PHP/Meterpreter_Binaries/Staged/Read_Me.txt
            echo -e "\n- set payload php/meterpreter/reverse_tcp for Rev_TCP1_shikata.php" >> Payload_List/PHP/Meterpreter_Binaries/Staged/Read_Me.txt
        ...
        mkdir Payload_List/PHP/Meterpreter_Binaries/Stageless 2>/dev/null
            echo -e "[*] The following Reverse Shell will run with meterpreter, make sure you set the payload and other options:" > Payload_List/PHP/Meterpreter_Binaries/Stageless/Read_Me.txt
        ...
        mkdir Payload_List/Ruby 2>/dev/null
            echo -e "[*] The following Reverse Shell will run with netcat listener on the attacker pc:" > Payload_List/Ruby/hell_list.txt
        ...
        mkdir Payload_List/Netcat 2>/dev/null
            echo -e "[*] The following Reverse Shell will run with netcat listener on the attacker pc:" > Payload_List/Netcat/Shell_list.txt
        ...
        mkdir Payload_List/NetcatOpenBsd 2>/dev/null
            echo -e "[*] The following Reverse Shell will run with netcat listener on the attacker pc:" > Payload_List/NetcatOpenBsd/Shell_list.txt
        ...
        mkdir Payload_List/AWK 2>/dev/null
            echo -e "[*] The following Reverse Shell will run with netcat listener on the attacker pc:" > Payload_List/AWK/Shell_list.txt
        ...
        mkdir Payload_List/Golang 2>/dev/null
            echo -e "[*] The following Reverse Shell will run with netcat listener on the attacker pc:" > Payload_List/Golang/Shell_list.txt
        ...
        mkdir Payload_List/Lua 2>/dev/null
            echo -e "[*] The following Reverse Shell will run with netcat listener on the attacker pc:" > Payload_List/Lua/Shell_list.txt
        ...
        mkdir Payload_List/Telnet 2>/dev/null
            echo -e "[*] The following Reverse Shell will run with netcat listener on the attacker pc:" > Payload_List/Telnet/Shell_list.txt
        ...
        mkdir Payload_List/Binary/Meterpreter_Binaries/Staged 2>/dev/null
            echo -e "[*] The following reverse shell will run with meterpreter or netcat, make sure you set the payload and other options on your meterpreter:" > Payload_List/Binary/Meterpreter_Binaries/Staged/Read_Me.txt
        ...
        mkdir Payload_List/Binary/Meterpreter_Binaries/Stageless 2>/dev/null
            echo -e "[*] The following reverse shell will run with meterpreter or netcat, make sure you set the payload and other options on your meterpreter:" > Payload_List/Binary/Meterpreter_Binaries/Stageless/Read_Me.txt
        ...
        mkdir Payload_List/Binary/Non_Meterpreter_Binaries/Staged 2>/dev/null
            ...
            echo -e "\n- set payload linux/x64/shell/reverse_tcp for x64_Rev_Shell_TCP.elf" >> Payload_List/Binary/Non_Meterpreter_Binaries/Staged/Read_Me.txt
    ...
    if [[ $ty == "1" ]]; then
        ...
        mkdir Payload_List/Powershell 2>/dev/null
            echo -e "[*] The following Reverse Shell will run with netcat listener on the attacker pc:" > Payload_List/Powershell/Shell_list.txt
        ...
        mkdir Payload_List/Meterpreter_Binaries/Staged 2>/dev/null
            echo -e "[*] The following binaries run with meterpreter, make sure you set the payload and other options on your meterpreter:" > Payload_List/Meterpreter_Binaries/Staged/Read_Me.txt
        ...
        mkdir Payload_List/Meterpreter_Binaries/Stageless 2>/dev/null
            echo -e "[*] The following binaries run with meterpreter, make sure you set the payload and other options on your meterpreter:" > Payload_List/Meterpreter_Binaries/Stageless/Read_Me.txt
        ...
        mkdir Payload_List/Non_Meterpreter_Binaries/Staged 2>/dev/null
            echo -e "[*] The following Reverse Shell will run with netcat listener on the attacker pc or you may use meterpreter with it, just set the payload and other options:" > Payload_List/Non_Meterpreter_Binaries/Staged/Read_Me.txt
        ...
        mkdir Payload_List/http 2>/dev/null
            echo -e "[*] The following binaries run with meterpreter, make sure you set the payload and other options on your meterpreter:" > Payload_List/http/Read_Me.txt
